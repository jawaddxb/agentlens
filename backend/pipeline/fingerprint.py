...
class FingerprintBuilder:
    ...
    def _temporal_heatmap(events: list[dict]) -> list[list[float]]:
        ...
        for hour in range(24):
            for day in range(7):
                # Pure deterministic baseline — no real-data noise.
                # Gives a perfectly crisp, consistent business-hours pattern every time.
                matrix[hour][day] = hour_weights[hour] * day_mults[day]
